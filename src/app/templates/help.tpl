<div class="help-container">
    ...
    <div class="content">
        ...
        <div class="help-outer">
            <h2 class="top"><%= i18n.__("What does Phancast offer?") %></h2>
            <p><%= i18n.__("With Phancast, you can watch Movies and TV Series really easily. All you have to do is click on one of the covers, then click 'Watch Now'. But your experience is highly customizable:") %>
                <ul>
                    <li><b><%= i18n.__("Movies") %>:</b> <%= i18n.__("Our Movies collection only contains High-Definition movies, available in 720p and 1080p. To watch a movie, simply open Phancast and navigate through the movies collection, reachable through the 'Movies' tab, in the navigation bar. The default view will show you all movies sorted by popularity, but you can apply your own filters, thanks to the 'Genre' and 'Sort by' filters. Once you have chosen a movie you want to watch, click its cover. Then click 'Watch Now'. Don't forget the popcorn!") %></li>
                    ...
                    <li><b><%= i18n.__("Custom Torrents and Magnet Links") %>:</b> <%= i18n.__("You can use custom torrents and magnets links in Phancast. Simply drag and drop .torrent files into the application's window, and/or paste any magnet link.") %></li>
            ...
            <h2><%= i18n.__("How does Phancast work?") %></h2>
            <p><%= i18n.__("Phancast streams video content through torrents. Our tv & movies are provided by 3rd party api's, same for subtitles. Phancast OnDemand does not host any content used within it.") %><br>
            ...
            <%= i18n.__("Once the movie is fully downloaded, you continue to send parts to the other users. And everything is deleted from your computer when you close Phancast. As simple as that.") %><br><br>
            <%= i18n.__("The application itself is built with Node-Webkit, HTML, CSS and Javascript. It works like the Google Chrome browser, except that you host the biggest part of the code on your computer. Yes, Phancast works on the same technology as a regular website, like... let's say Wikipedia, or Youtube!") %>
            </p>
            ...
            <p>
                ...
                <b>B) <%= i18n.__("Second method") %></b><br>
                    <%= i18n.__("You can create an account on our %s repository, and click on %s.", '<a class="links" href="https://github.com/phantomware/phancast-app/issues">GitLab</a>', '"Issues"') %>
