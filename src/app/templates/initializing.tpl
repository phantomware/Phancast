...
<div class="text-begin">
	<div class="init-text"><%= i18n.__("Initializing Phancast OnDemand. Please Wait...") %></div>
	...
	<p id='waiting-block' style="margin-top:20px;display:none">
			<center><a href='#' style='color:#fff;font-weight:bold;' class='fixApp'><%= i18n.__("Loading stuck ? Click here !") %></a></center>
	</p>
