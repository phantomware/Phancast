    ...
    <section id="cache">
        <div class="content"><div class="title"><%= i18n.__("Playback") %></div>
	    	...
	    	<span class="advanced">
                ...
                <label class="settings-label" for="playNextEpisodeAuto" title="Automatically play the next episode in a series for an uninterrupted experience (works only for Phancast)"><%= i18n.__("Play next episode automatically") %></label>
            </span>
	...
	<section id="trakt-tv" class="advanced">
        <div class="content"><div class="title"><%= i18n.__("Trakt.tv") %></div>
            ...
            <div class="trakt-options<%= App.Trakt.authenticated ? " authenticated" : "" %>">
                ...
                <% } else { %>
                    <span>
                        <%= i18n.__("Connect to %s to automatically 'scrobble' episodes you watch in %s", "Trakt.tv", "Phancast") %>
                    </span>
                    <span>
