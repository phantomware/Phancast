<ul class="nav nav-hor left">
	...
	<li class="source active showMovies providerinfo" data-toggle="tooltip" data-placement="top" title="MOVIES ONDEMAND"><span class="fa fa-ticket fa-lg fa-fw"><%= i18n.__("") %></span></li>
	<li class="source showShows providerinfo" data-toggle="tooltip" data-placement="top" id="TVApi" title="TV ONDEMAND"><span class="fa fa-desktop fa-lg fa-fw"><%=i18n.__("") %></span></li>
		<li class="source showAnime providerinfo" data-toggle="tooltip" data-placement="top" title="ANIME ONDEMAND"><span class="fa fa-photo fa-lg fa-fw"><%=i18n.__("") %></span></li>
</ul>
