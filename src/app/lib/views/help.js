(function (App) {
    ...
    var Help = Backbone.Marionette.ItemView.extend({
        ...
        initialize: function () {
            dyks = [
                i18n.__('You can paste magnet links anywhere in Phancast with CTRL+V.'),
                i18n.__('You can drag & drop a .torrent file into Phancast.'),
                i18n.__('The Phancast project started in February 2014 and has already had 150 people that contributed more than 3000 times to it\'s development in August 2014.'),
