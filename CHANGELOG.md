## 0.4.1 Beta - Give me some Nachos - 5 June 2016
...
- rename application to Phancast Interactive 
- rename github organization to Phancast Interactive
...
- Fix the Phancast player when watching trailers.
...
- Start Phancast minimized with "-m" flag
- 1080p TV Shows are here !
- "Big Picture Mode" will allow you to read Phancast's texts from your couch
...
- Added in a BitTorrent PeerID specific to Phancast
...
- Move to self-hosted repo, you can now find us at https://github.com/phantomware/phancast.git 
...
- Themes: we give you 3 new themes to check out, and soon you'll be able to
  submit your own.
- HTTP Api: to control Phancast from another application
- New settings: 
